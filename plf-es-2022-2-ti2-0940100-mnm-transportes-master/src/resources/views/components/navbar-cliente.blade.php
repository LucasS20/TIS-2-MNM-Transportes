<nav class="w-full bg-white z-30 absolute top-0 shadow-md flex justify-between items-center py-2 px-5 h-16">
    ...
    <div class="flex gap-10 justify-center items-center">
        <a href="{{ route('cadastro.servico') }}" class="uppercase text-xs border rounded-full px-10 py-2 border-blue-400 bg-blue-400 text-white font-semibold">Novo serviço</a>
